...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        NotificationCenter.default.addObserver(forName: NSNotification.Name(rawValue: "NewUser"), object: nil, queue: OperationQueue.main, using: {(Notification) -> () in
            //TODO: perform any needed cleanup here
    ...
    func switchToWelcomeController() {
        let storyboard = UIStoryboard(name: "Login", bundle: nil)
